...
function smoothScroll(target, duration) {
    ...
    let targetPosition = window.scrollY + clickedTarget.getBoundingClientRect().top;
...
const clickedContactIcon = document.querySelector(".fa-comment-dots")
...
clickedContactIcon.addEventListener("click", function(){
    smoothScroll("#section3-content", 2000);
})
